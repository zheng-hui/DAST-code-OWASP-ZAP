...
<html>
    ...
    <body>
        ...
        <?php if($edit ==true){ ?>
    <center>
        <form id='form' name='doDeleteReview' method='post'>
            <h1 font-weight="bold">Review Successfully Deleted!</h1>
                <a href="hotelReview.php?hotelId=<?php echo $hotelId; ?>">Back</a> to review page!
                </form>
            <?php
        } else { ?>
            Review failed to delete
        <?php } ?>
    </center>
    </body>
</html>
