...
$edit = true;
$query = "UPDATE reviews SET review='$newReview', rating='$newRating' WHERE reviewId = $thereviewId";
...
<html>
    ...
    <body>
        ...
        <?php if($edit ==true){ ?>
    <center>
        <form id='form' name='doEditReview' method='post'>
            <h1 font-weight="bold">Review Successfully Edited!</h1>
                <a href="hotelReview.php">Back</a> to review page!
                </form>
            <?php
        } else { ?>
